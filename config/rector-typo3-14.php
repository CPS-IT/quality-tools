...
// This file contains the Rector configuration targeting TYPO3 v14.
// Use this file explicitly when you need to analyze code against TYPO3 v14 rules:
...
// Default scan paths for TYPO3 v14
$scanPaths = [
...
return RectorConfig::configure()
    ...
    ->withSkip([
        ...
        // Crashes with null dim on append-syntax array assignments unrelated to Scheduler.
        // @see https://github.com/sabbelasichon/typo3-rector/issues/4882
        MoveSchedulerFrequencyOptionsToTCARector::class,
    ]);
