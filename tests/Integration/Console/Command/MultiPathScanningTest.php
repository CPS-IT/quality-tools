...
final class MultiPathScanningTest extends TestCase
{
    ...
    public function rectorScansAllConfiguredPaths(): void
    {
        ...
        mkdir($this->tempProjectRoot . '/vendor/company', 0777, true);
        mkdir($this->tempProjectRoot . '/vendor/company/pkg1', 0777, true);
        mkdir($this->tempProjectRoot . '/vendor/company/pkg2', 0777, true);
...
YAML;
        ...
        $vendorPaths = array_filter($resolvedPaths, fn($path) => strpos($path, '/vendor/company/') !== false);
