...
final class PathScannerTest extends TestCase
{
    ...
    public function testResolveGlobPattern(): void
    {
        ...
        mkdir($this->tempDir . '/packages/ext1', 0o777, true);
        mkdir($this->tempDir . '/packages/ext2', 0o777, true);
        mkdir($this->tempDir . '/packages/ext3', 0o777, true);
    ...
    public function testResolveVendorNamespacePattern(): void
    {
        ...
        mkdir($vendorDir . '/cpsit/package1', 0o777, true);
        mkdir($vendorDir . '/cpsit/package2', 0o777, true);
        mkdir($vendorDir . '/fr/package3', 0o777, true);
    ...
    public function testResolveVendorNamespacePatternWithSubpath(): void
    {
        ...
        mkdir($vendorDir . '/cpsit/package3', 0o777, true);
    ...
    {
        // Create test directories
        mkdir($this->tempDir . '/packages/good1', 0o777, true);
        mkdir($this->tempDir . '/packages/good2', 0o777, true);
        mkdir($this->tempDir . '/packages/legacy', 0o777, true);
    ...
    public function testResolvePathsAreSorted(): void
    {
        ...
        mkdir($this->tempDir . '/zzz', 0o777, true);
        mkdir($this->tempDir . '/aaa', 0o777, true);
        mkdir($this->tempDir . '/mmm', 0o777, true);

        $result = $this->scanner->resolvePaths(['zzz', 'aaa', 'mmm']);

        // Should be sorted alphabetically
        self::assertCount(3, $result);
        self::assertTrue(str_contains((string) $result[0], 'aaa'));
        self::assertTrue(str_contains((string) $result[1], 'mmm'));
        self::assertTrue(str_contains((string) $result[2], 'zzz'));
    }

    public function testResolvePathsRemovesDuplicates(): void
    {
        // Create test directory
        mkdir($this->tempDir . '/test', 0o777, true);
    ...
    public function testPatternTypeDetection(): void
    {
        ...
        $vendorDir = $this->tempDir . '/vendor';
        mkdir($vendorDir . '/cpsit', 0o777, true); // Create cpsit namespace to make it vendor_namespace type
        $this->scanner->setVendorPath($vendorDir);
    ...
    public function testExclusionWithGlobPattern(): void
    {
        ...
        mkdir($this->tempDir . '/packages/good', 0o777, true);
        mkdir($this->tempDir . '/packages/legacy1', 0o777, true);
        mkdir($this->tempDir . '/packages/legacy2', 0o777, true);
    ...
    public function testVendorPathUpdate(): void
    {
        ...
        mkdir($vendorDir1 . '/cpsit/package1', 0o777, true);
        mkdir($vendorDir2 . '/cpsit/package2', 0o777, true);
    ...
    {
        // Create test directories
        mkdir($this->tempDir . '/test1', 0o777, true);
        mkdir($this->tempDir . '/test2', 0o777, true);
